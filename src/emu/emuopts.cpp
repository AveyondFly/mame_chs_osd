...
const options_entry emu_options::s_option_entries[] =
{
	...
	{ OPTION_PLUGINDATAPATH,                             "/storage/roms/mame",           core_options::option_type::PATH,     "path to home directory (read/write) location" },
	{ OPTION_MEDIAPATH ";rp;biospath;bp",                "/storage/roms/mame;/storage/roms/bios/mame/bios",          core_options::option_type::MULTIPATH,     "path to ROMsets and hard disk images" },
	...
	{ OPTION_INIPATH,                                    "$HOME/.config/APP_NAME;/storage/roms/bios/mame/ini",     core_options::option_type::MULTIPATH,     "path to ini files" },
	{ OPTION_FONTPATH,                                   "/storage/roms/bios/mame/font",         core_options::option_type::MULTIPATH,     "path to font files" },
	{ OPTION_CHEATPATH,                                  "/storage/roms/bios/mame/cheat",     core_options::option_type::MULTIPATH,     "path to cheat files" },
	...
	{ OPTION_CFG_DIRECTORY,                              "/storage/roms/mame/mame/cfg",       core_options::option_type::MULTIPATH,     "directory to save configurations" },
	{ OPTION_NVRAM_DIRECTORY,                            "/storage/roms/mame/mame/nvram",     core_options::option_type::MULTIPATH,     "directory to save NVRAM contents" },
	{ OPTION_INPUT_DIRECTORY,                            "/storage/roms/mame/mame/inp",       core_options::option_type::MULTIPATH,     "directory to save input device logs" },
	{ OPTION_STATE_DIRECTORY,                            "/storage/roms/mame/mame/sta",       core_options::option_type::MULTIPATH,     "directory to save states" },
	{ OPTION_SNAPSHOT_DIRECTORY,                         "/storage/roms/mame/mame/screenshots",      core_options::option_type::MULTIPATH,     "directory to save/load screenshots" },
